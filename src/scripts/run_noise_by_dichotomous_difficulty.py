...
@hydra.main(config_path=config_path, config_name="noise_by_dichotomous_difficulty")
def main(args: DictConfig):
    ...
    counts = pd.read_csv(os.path.join(ROOT_DIR, "results/counts/{}".format(args.counts_path)))
